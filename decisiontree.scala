...
val featureIndexer = new VectorIndexer().setInputCol("features").setOutputCol("indexedFeatures").setMaxCategories(6).fit(data)
...
DecisionTreeClassificationModel (uid=dtc_adaa8422dd17) of depth 5 with 19 nodes
  If (feature 5 in {0.0})
   Predict: 0.0
